...
# [Índice](https://nextstrain.org/ncov/2020-03-20?d=tree,map&p=grid)

* [Recursos base](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=2).     
* [Nota acerca da amostragem](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=3).
* [Dados acerca das sequências e históricos de viagem](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=6).
* [Introdução da COVID-19 em quase todos os países](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=8).
* [Como os surtos crescem e se propagam](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=9).
* [Como cresceu o surto em Washington](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=10).
* [Como a epidemia se espalhou em Washington](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=11).
* [De que forma as contagens de casos se alteram com distanciamento social](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=12).
* [O que você pode fazer](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=13).
* [Reconhecimentos científicos](https://nextstrain.org/narratives/ncov/sit-rep/pt/2020-03-20?n=14).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Resumo

Analisamos 723 genomas do vírus causador da COVID-19 publicamente disponíveis. Ao compararmos estes genomas entre si, podemos caracterizar de que forma a doença COVID-19 se espalha pelo mundo.

Neste relatório chamamos a atenção para o vírus ter sido introduzido e estar em circulação em muitas partes do mundo.
Para saber se e em que medida a COVID-19 circula localmente, e de que forma as medidas de mitigação podem conter essa propagação, precisamos ter um bom conhecimento das dinâmicas dos surtos locais. Isso, por sua vez, requer uma cobertura de testagem abrangente.
Destacamos aqui a importância das testagens rápidas, as quais têm por foco conter as transmissões locais.

No relatório desta semana, informamos o seguinte:  

* Evidências de introduções associadas a viagens em muitas partes do mundo.  
* Muitos locais com introduções recentes podem esperar ver uma expansão do número de casos num prazo de 4-8 semanas. Tais países devem preparar-se imediatamente para conter ou mitigar os efeitos da epidemia.   
* Muitos locais que implementaram recentemente medidas de distanciamento social poderão continuar a acumular casos a curto prazo, mas o número de novos casos irá provavelmente nivelar e diminuir a médio e longo prazo.
* A testagem para determinação de infeções ativas e em indivíduos recuperados será vital para lidar com esta epidemia.
```
...
# [Recursos acerca da COVID-19](https://nextstrain.org/ncov/2020-03-20)
Preparamos alguns recursos que vale a pena ler para se familiarizar com a COVID-19 e com o vírus que a causa, o SARS-CoV-2.
Esta informação fará com que a interpretação dos dados que apresentamos nesta narrativa seja mais fácil. Caso não esteja familiarizado(a) com árvores filogenéticas, encorajamos que consulte a [narrativa “Como ler filogenias'](https://nextstrain.org/narratives/trees-background/pt) e que aqui regresse quando estiver pronto(a).
...
<div>
  <a href="https://nextstrain.org/help/coronavirus/human-CoV"><img alt="microscopy image of coronaviruses" width="100" src="https://nextstrain.org/static/ncov_narrative-76cfd610d11ef708d213a3170de9519f.png"/> Informação de referência acerca dos coronavírus </a>.

  <a href="https://nextstrain.org/help/coronavirus/SARS-CoV-2"><img alt="illustration of a coronavirus" width="100" src="http://data.nextstrain.org/img_nCoV-CDC.jpg"/> Informação de referência acerca do surto recente de COVID-19 </a>

  <a href="https://nextstrain.org/narratives/trees-background/pt"><img alt="cartoon of a phylogenetic tree" width="100" src="http://data.nextstrain.org/img_toy_alignment_mini.png"/> Como ler filogenias</a>
</div>

## Leitura adicional

* Resumo do surto de SARS-CoV-2 na [Wikipedia](https://en.wikipedia.org/wiki/2019%E2%80%9320_Wuhan_coronavirus_outbreak).
* Todas as contagens de casos citadas neste relatório foram obtidas a partir da [OMS](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200318-sitrep-58-covid-19.pdf?sfvrsn=20876712_2) à data de 20 de Março de 2020.
```

<!-- ############ SLIDE BREAK ############# -->

<!-- This is left-side text 3 -->
# [Nota acerca da amostragem](https://nextstrain.org/ncov/2020-03-20?c=country&r=country&d=map&p=grid&legend=closed)
Temos atualmente sequências de amostras recolhidas em 36 países, em 6 continentes. Isto é um feito incrível - sequenciar um vírus de RNA desconhecido, de grande dimensão, no meio a uma pandemia é algo difícil, e apenas é possível através do trabalho incrível e pronto compartilhamento de dados por cientistas e médicos por todo o mundo.
<br><br>
Apesar de estes dados nos permitirem inferir muitas particularidades úteis do surto e seguir a sua dispersão em tempo real, é importante salientar que as nossas conclusões estão limitadas pela disponibilidade de dados.
Apenas um subconjunto de doentes é testado da totalidade dos casos. Apenas um subconjunto das amostras testadas é também sequenciado.
O subconjunto de casos que é testado e sequenciado pode variar significativamente através das várias regiões geográficas e ao longo do tempo.
Para além disso, as reconstruções filogenéticas de surtos acarretam sempre num determinado grau de incerteza.
<br><br>
...
# [Algumas regiões estão sub-representadas nestes dados](https://nextstrain.org/ncov/2020-03-20?c=country&d=map&f_region=Central%20America,Oceania,South%20America,Africa&legend=closed&p=full&r=country)
Este mapa mostra muito poucas sequências com origem no sul global. Por exemplo, apenas temos sequências de 4 dos 25 países na América Latina em que [a OMS relata](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200319-sitrep-59-covid-19.pdf?sfvrsn=c3dcdef9_2) casos de COVID-19. Isto não se deve ao facto de a COVID-19 não circular nestas áreas, ou a estes casos não serem tão cruciais para compreensão. Simplesmente não temos muitos dados disponíveis com origem nestas áreas.
<br><br>
<!-- There is NO right-side text -->
...
# [Outras regiões estão sobre-representadas nestes dados](https://nextstrain.org/ncov/2020-03-20?c=country&d=map&f_region=Europe&legend=closed&p=full&r=country)
Em outras áreas, tais como nos Países Baixos (Holanda), existe uma vasta quantidade de sequências disponível face ao número total de casos.
<br><br>
Assim sendo, ao ler esta narrativa, tenha em mente que a dimensão de cada círculo no mapa indica quantos dados estão atualmente disponíveis com origem nessa área, ao invés da verdadeira dimensão do surto. [Leia aqui](https://nextstrain.org/narratives/trees-background/pt?n=8) acerca de como tais diferenças de amostragem podem afetar as nossas inferências acerca da transmissão.
<br><br>
...
# [Os dados acerca das sequências podem confirmar os históricos de viagem](https://nextstrain.org/ncov/2020-03-20?legend=open&c=division_exposure&label=clade:A1a&d=tree)

A identificação da origem de um determinado caso é importante para compreender em que áreas existe transmissão local, e em que áreas existem principalmente casos associados a viagens. Os dados de sequência podem ajudar-nos a diferenciar entre estes dois cenários.
<br><br>
Aqui, a árvore filogenética está colorida de acordo com o histórico de viagem de um caso (quando este é conhecido). Olhando para a sequência do Canadá (Canada/BC_78548/2020), ao centro, podemos observar que esta tem um histórico de viagem para a Europa. Esta sequência agrupa-se com outras sequências europeias, indicando que este caso é quase certamente um caso relacionado a uma viagem.

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 7 -->
# [Os dados acerca das sequências podem confirmar os históricos de viagem](https://nextstrain.org/ncov/2020-03-20?c=division_exposure&d=tree&f_division_exposure=Iran&legend=open&p=full)

Reduzindo a ampliação, podemos observar que isto nem sempre é assim tão consistente.
<br><br>
Aqui podemos observar que quase todos os casos para os quais existem informações de viagem recente para o Irão (Irã) estão agrupados no meio da árvore.
<br><br>
No parte de cima da árvore, podemos também observar um caso identificado no Canadá com histórico de viagem para o Irão (Irã). Contudo, esta sequência não se agrupa junto com o resto dos casos com histórico de viagem iraniano.
<br><br>
É certamente possível que esta pessoa tenha sido infetada por uma segunda cadeia de transmissão no Irão (Irã), mas não podemos confirmar que esta infeção foi adquirida numa viagem até obtermos mais dados.
...
# [O vírus foi introduzido em praticamente todos os países do mundo](https://nextstrain.org/ncov/2020-03-20?legend=closed&c=country&d=tree,map&p=grid)

Podemos observar na árvore muito entrelaçamento de amostras oriundas de diversos países.
Tal padrão indica que este tipo de movimentação humana inevitável já introduziu o vírus em muitas partes do mundo.
<br><br>
De fato, [a OMS relatou](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200319-sitrep-59-covid-19.pdf?sfvrsn=c3dcdef9_2) casos confirmados em 159 dos 195 países no mundo.
<br><br>
Contudo, nem todas as introduções resultaram em surtos.

<!-- There is no right side text -->

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 9 -->
# [As epidemias tornam-se evidentes aproximadamente 4-8 semanas após a introdução](https://nextstrain.org/ncov/2020-03-20?legend=closed&c=num_date&d=tree&f_division=Washington&label=clade:B1&p=full)

Aparentemente, a COVID-19 explodiu de repente.
Para muitas pessoas, esta epidemia deixou de ser uma preocupação abstrata, que afeta partes específicas do mundo, e passou a ser algo com um impacto grave nas suas vidas de um momento para o outro.
<br><br>
No entanto, tenha em mente que a atual situação tem estado a desenvolver-se há algum tempo. Tal fato não se deve ao vírus estar a ser introduzido em novos locais mais frequentemente.
O mais provável é que muitos países começam agora a ter consciência dos surtos localizados que foram iniciados por introduções há várias semanas.
<br><br>
As áreas que ainda não têm informação de surtos locais devem preparar-se imediatamente e iniciar testes de rastreio do vírus.  

<!-- This is the right-side text -->

```auspiceMainDisplayMarkdown
# Como as introduções se transformam em surtos?

Ocasionalmente, estas introduções não resultam em casos secundários ou focos localizados - especialmente se o caso índice for identificado e isolado rapidamente.
Contudo, em muitas das vezes, o vírus se espalha através da população local sem ser identificado, até que o surto atinge uma dimensão significativa.

Abaixo encontra-se um exemplo da forma como ocorreu em Wuhan. O eixo y (ordenadas) representa o espaço, o eixo x (abcissas) representa o tempo. A área a sombreado representa o número de casos.

“A COVID-19 em Wuhan propagou-se de um caso índice em novembro de 2019 a vários milhares de casos em meados de janeiro de 2020, partindo assim do acontecimento de disseminação inicial a transmissão local abrangente no prazo de aproximadamente 10 semanas. Pensamos que os acontecimentos de disseminação internacional começaram a ocorrer em meados de janeiro. Assim, temos um período crítico de aproximadamente 10 semanas desde aí até ao final de março para conter estes surtos nascentes antes de estes tomarem proporções significativas.” [- Trevor Bedford](https://twitter.com/trvrb/status/1226241284207038464), fevereiro de 2020
...
Tal padrão é consistente com uma introdução no estado de Utah proveniente de Washington, apesar de também ser possível terem ocorrido etapas intermédias na cadeia de transmissão.
<br><br>
Não sabemos com certeza se esta introdução irá resultar num surto local no estado de Utah.
Contudo, caso o vírus continue a se propagar após estas introduções, esperamos observá-lo ao longo das próximas 4 semanas.
<br><br>
Este é apenas um exemplo.
Podem ter ocorrido outras introduções no estado de Utah (ou em outras áreas) que não podemos observar na árvore porque estes não foram sequenciados.
O mais importante é que as áreas que ainda não têm informação de surtos locais devem preparar-se imediatamente e iniciar testes de rastreio do vírus.  

<!-- There is no right side text -->

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 12 -->
# [As medidas de mitigação demoram algum tempo, mas salvam vidas](https://nextstrain.org/ncov/2020-03-20)

Seguindo esta mesma lógica, provavelmente existem muitas cadeias de transmissão local que ainda desconhecemos.
<br><br>
Isso significa que devemos esperar um aumento da contagem de casos ao longo das próximas semanas, mesmo nas áreas que tenham acabado de implementar medidas de distanciamento social.
Estes aumentos NÃO indicam falhas nas medidas sendo implementadas. É necessário tempo para que os indivíduos já afetados (e possivelmente os membros do seu núcleo familiar) exibam sintomas, sejam tratados e se recuperem. Esperamos ainda ver um aumento no número de casos relatados, à medida que a disponibilidade de testagem aumentar.
<br><br>
A manutenção do distanciamento social é crítica durante este período. Tal como demonstrado à direita, as contagens de casos continuam a crescer após a intervenção ser implementada. Contudo, o número cumulativo de casos é fortemente diminuído com o passar do tempo.

<!-- This is the right-side text -->

```auspiceMainDisplayMarkdown
## O distanciamento social não interrompe imediatamente o surgimento de novos casos, mas diminui muito as contagens de casos e óbitos com o passar do tempo
...
# [Conclusões](https://nextstrain.org/ncov/2020-03-20?c=country&d=map&p=full)
- O vírus foi introduzido em muitas partes do mundo, por diversas vezes.  
<br>
- Estamos a observar evidências de transmissão local em muitas áreas. Para além disto, esperamos que as introduções anteriores tenham já disseminado muitos surtos locais que se tornarão evidentes nas próximas semanas.  
<br>
- A prevenção de surtos locais através do distanciamento social é crucial para:  
  - #FlattenTheCurve (#AchatemAcurva) para impedir que os sistemas de saúde sejam sobrecarregados por muitos casos simultâneos da doença  
  - Reduzir o número total de casos e de óbitos  
  - Dar tempo para o desenvolvimento de tratamentos e vacinas  
...
## ...como individuo
* Reduzir dramaticamente o número de pessoas com quem contacta diariamente, particularmente se estiver num grupo vulnerável (p. ex., idosos e pessoas com doenças pré-existentes).
...
* Apoie financeiramente os afetados pelas medidas de distanciamento social (p. ex., trabalhadores pagos à hora, pessoas que cuidam de idosos ou crianças, pequenas empresas, etc.).
```
