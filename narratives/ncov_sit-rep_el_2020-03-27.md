---
title: Γενωμική ανάλυση της εξάπλωσης του COVID-19. Κατάσταση 2020-03-27.
authors:
  - Sidney M. Bell
  - Nicola Müller
  - Emma Hodcroft
...
* [Ενημερώσεις απο την Ευρώπη](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=4).  
* [Ενημερώσεις απο τη Βόρεια Αμερική](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=7).  
* [Ενημερώσεις απο την Κεντρική και Νότια Αμερική](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=11).  
* [Ενημερώσεις απο την Ασία](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=13).  
* [Ενημερώσεις απο την Αφρική](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=15).  
* [Ενημερώσεις απο την Ωκεανία](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=17).  
* [Τι μπορείτε να κάνετε](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=19).  
* [Επιστημονικές ευχαριστίες](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=20).  
<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Γενική περίληψη

Έχουμε αναλύσει 1.495 δημοσίως διαθέσιμα γονιδιώματα COVID-19. Συγκρίνοντας αυτά τα ιικά γονιδιώματα μεταξύ τους, μπορούμε να κατανοήσουμε πώς μετακινείται ο COVID-19 στην υφήλιο και πώς διασπείρεται τοπικά. Στην αναφορά αυτής της εβδομάδας αναφέρουμε:

**Ευρώπη**  
* Συνεχίζουμε να βλέπουμε έντονη ανάμιξη των δειγμάτων σε όλη την Ευρώπη, πράγμα που υποδηλώνει ότι ο ιός συνεχίζει να μετακινείται πέραν των συνόρων των χωρών τις τελευταίες 3-5 εβδομάδες. Με την πάροδο του χρόνου και δεδομένου ότι έχουν επιβληθεί μέτρα περιορισμού της εξάπλωσης του ιού, ενδεχομένως να μπορέσουμε να δούμε μεγαλύτερη ομαδοποίηση στις αλληλουχίες των κρουσμάτων ανά χώρα.

**Βόρεια Αμερική**   
* Εντός των ΗΠΑ, το μοτίβο διασποράς του ιού είναι πολύπλοκο: δείγματα που έχουν συλλεγεί και από τις δύο άκρες της χώρας, δείχνουν ακόμα να έχουν πολύ στενή σχέση μεταξύ τους.
* Η πολιτεία της Washington έχει τουλάχιστον δύο ανεξάρτητες εισαγωγές του ιού (η πρώτη πιθανώς από την Κίνα, η δεύτερη πιθανώς από την Ευρώπη), γεγονός που έχει ως αποτέλεσμα να υπάρχουν δύο ξεχωριστές αλυσίδες μετάδοσης του ιού.
* Υπάρχουν ενδείξεις για πιθανή τοπική διασποτά εντός πολλών κρατιδίων, περισσότερο εμφανώς εντός της California.

**Κεντρική και Νότια Αμερική**
* Παραλάβαμε νέες αλληλουχίες από τη Νότια Αμερική αυτή την εβδομάδα, όμως η δειγματοληψία παραμένει αραιή. Ίσως υπάρχει μεγαλύτερη δραστηριότητα του COVID-19 στην περιοχή που δεν αντικατοπτρίζεται στα διαθέσιμα δεδομένα, αλλά δεν μπορούμε να το γνωρίζουμε αυτό με ακρίβεια.

**Ασία**  
* Υπάρχουν ενδείξεις για πρόσφατη εξαγωγή του COVID-19 από το Ιράν.

**Αφρική**  
* Το φυλογενετικό δέντρο υποδηλώνει την πιθανότητα τοπικής εξάπλωσης στην Kinshasa στη Λαϊκή Δημοκρατία του Κονγκό, τις τελευταίες 11+ μέρες.
* Έχουμε λάβει νέες αλληλουχίες από την Αφρική αυτή την εβδομάδα, αλλά η δειγματοληψία παραμένει αραιή. Πιθανώς να υπάρχει πολύ μεγαλύτερη δραστηριότητα του COVID-19 από αυτήν που απωτυπώνεται στα διαθέσιμα δεδομένα.

**Ωκεανία**
* Τα γενετικά δεδομένα δείχνουν ότι υπάρχει εντοπισμένη τοπική εξάπλωση στην περιοχή New South Wales της Αυστραλίας.
```
...
# [Μια σημείωση σχετικά με τη δειγματοληψία](https://nextstrain.org/ncov/2020-03-27?c=country&r=country&d=map&p=grid&legend=closed)
Αυτή τη στιγμή έχουμε αλληλουχίες από δείγματα που έχουν ληφθεί σε 48 χώρες σε 6 ηπείρους. Αυτό είναι ένα αξιόλογο κατόρθωμα - η αλληλούχηση ενός ιού με μεγάλο RNA γονιδίωμα εν μέσω πανδημίας είναι δύσκολη και είναι η εξαιρετική δουλειά και ο συνεχής διαμοιρασμός δεδομένων από επιστήμονες και γιατρούς σε όλο τον κόσμο που την καθιστούν δυνατή.
<br><br>
Αν και τα δεδομένα μας επιτρέπουν να εξαγάγουμε αρκετά χρήσιμα χαρακτηριστικά για την επιδήμια και να παρακολουθήσουμε την εξάπλωσή της σε πραγματικό χρόνο, είναι σημαντικό να επισημάνουμε ότι τα συμπερασματά μας περιορίζονται απο τα διαθέσιμα δεδομένα.
<br><br>
Για παράδειγμα, ο χάρτης παρουσιάζει πολύ λίγες αλληλουχίες απο το νότιο ημισφαίριο. Αυτό ΔΕΝ ειναι επειδή δεν υπάρχει διάδοση COVID-19 σε αυτές τις περιοχές, ή ότι τα κρούσματα αυτά είναι λίγοτερο σημαντικά για να κατανοήσουμε. Αντιθέτως, απλά δεν έχουμε αρκετά δεδομένα διαθέσιμα απο αυτές τις περιοχές.
Το μέγεθος κάθε κύκλου στο χάρτη υποδηλώνει πόσα δεδομένα είναι διαθέσιμα αυτή τη στιγμή απο τις αντίστοιχες περιοχές, και όχι το πραγματικό μέγεθος της επιδημίας στις περιοχές αυτές.
...
# [Ενημερώσεις απο την Ευρώπη](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Europe&p=grid&r=country&c=country)
...
# [Συνεχιζόμενη διασπορά του ιού πέραν των συνόρων τις τελευταίες 3-5 εβδομάδες.](https://nextstrain.org/ncov/2020-03-27?c=country&d=tree,map&dmin=2020-03-06&f_region=Europe&p=full&r=country&legend=closed)

Εδώ βλέπετε δείγματα που έχουν συλλεχθεί στην Ευρώπη τις τελευταίες 3 εβδομάδες με χρώματα που αντιστοιχούν στη χώρα από την οποία έχουν συλλεχθεί.
Αξίζει να σημειωθεί πως όσο υπάρχουν μικρές ομάδες που είναι συνδεδεμένες με την αντίστοιχη χώρα από την οποία προέρχονται, υπάρχει ταυτόχρονα ένας μεγάλος αριθμός αναμίξεων σε δείγματα που προέρχονται απο διαφορετικές χώρες.
<br><br>
Αυτό σημαίνει ότι πιθανόν υπήρχε συνεχιζόμενη διασπορά του ιού πέραν των συνόρων τις τελευταίες 3-5 εβδομάδες.
<br><br>
Αυτή η γεωγραφική ομαδοποίηση ενδεχομένως να γίνει ισχυρότερη μετά την επιβολή των πρόσφατων μέτρων αλλά και του περιορισμού ταξίδίων μεταξύ των χωρών.
<!-- There is no right side text -->

<!-- ##### slide break ##### -->
<!-- This is left-side text 5-->
# [Νέες αλληλουχίες απο την Ισλανδία](https://nextstrain.org/ncov/2020-03-27?c=division_exposure&d=tree,map&f_country=Iceland&legend=open)

Λάβαμε αρκετές αλληλουχίες απο την Ισλανδία.
Χρωματίζοντας ανάλογα με το ιστορικό ανίχνευσης του ιού (όταν αυτό είναι γνωστό), παρατηρούμε ότι πολλά από τα κρούσματα προέρχονται από πρόσφατα ταξίδια.
Δουλεύουμε σκληρά για να αναλύσουμε όλα αυτά τα νέα δεδομένα και θα γνωστοποιήσουμε τα αποτελέσματά μας την επόμενη εβδομάδα.
<!-- There is no right side text -->


<!-- ############ NORTH AMERICA ############# -->
<!-- This is left-side text 6-->
# [Ενημερώσεις απο τη Βόρεια Αμερική](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=North%20America&p=grid&r=location&legend=closed)
...
# [Η διασπορά του ιού στις Ηνωμένες Πολιτείες είναι πολύπλοκη και δεν ειναι αρκετά κατανοητή](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_division=Connecticut&label=clade:B1&m=div&p=full)

Ακόμη και στις ΗΠΑ το μοτίβο διασποράς του ιού είναι αρκετά πολύπλοκο.
<br><br>
Παραδείγματος χάριν, τα πρόσφατα δείγματα από το Connecticut (επιλεγμένα κλαδιά), είναι ταυτόχρονα προγονικά αλλά και ανάμικτα με δείγματα από την πολιτεία της Washington (υποχρωματισμένα κλαδιά).
Ενώ χρειαζόμαστε περισσότερα δεδομένα ώστε να βγάλουμε συμπεράσματα, παρατηρούμε ότι υπάρχει πρόσφατη διασπορά ακόμα και σε περιοχές της χώρας που είναι απομακρυσμένες.
<br><br>
Το γεγονός αυτό καταδεικνύει ότι το μοτίβο διασποράς του ιού στις ΗΠΑ είναι πολύ πιο περίπλοκο από αυτό που βλέπουμε με τα έως τώρα διαθέσιμα δεδομένα.
Επιπλέον δεδομένα θα μας βοηθήσουν να κατανοήσουμε ότι πρόκειται μάλλον για μια επιδημία που είναι βαθιά διασυνδεδεμένη σε εθνικό επίπεδο η οποία έως τώρα αντικατοπτρίζει τις ετερογενείς αποκρίσεις των διάφορων πολιτειών.
<!-- There is no right side text -->


<!-- ##### slide break ##### -->
<!-- This is left-side text 8-->
# [Πολλαπλές αλυσίδες διασποράς κυκλοφορούν στη πολιτεία της Washington](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_country=USA&f_division=Washington&p=full&r=location)

Παρατηρώντας τα κρούσματα στην πολιτεία της Washington, βλέπουμε ότι υπάρχουν τουλάχιστον δύο ξεχωριστές επιδημιολογικές τοπικές ομάδες.
<br><br>
Ωστόσο, οι δύο αυτές ομάδες έχουν διαφορετική πηγή: η πρώτη είναι πιο συγγενική σε δείγματα από την Κίνα, ενώ η δεύτερη είναι πιο συγγενική σε δείγματα από την Ευρώπη.
<br><br>
<!-- There is no right side text -->
...
# [Πιθανώς δύο τοπικές αλυσίδες διασποράς στην California](https://nextstrain.org/ncov/2020-03-27?c=location&f_country=USA&f_division=California&label=clade:A7&p=full&r=location&m=div&d=tree,map)

Παρόμοιο μοτίβο παρατηρείται και αλλού στις ΗΠΑ.
<br><br>
Εδώ βλέπουμε διάφορα δείγματα από το Solano County της βόρειας California, τα οποία έχουν ληφθεί σε διαφορετικές ημερομηνίες αλλά είναι πολύ συγγενικά μεταξύ τους.
<br><br>
Ενώ τα διαθέσιμα δεδομένα από την California είναι περιορισμένα ώστε να εξάγουμε ασφαλή συμπεράσματα, αυτή η πρώτη ένδειξη συμφωνεί με το μοτίβο τοπικής διασποράς μέσα στο Solano County.
<br><br>
Σε άλλα σημεία του δέντρου, βλέπουμε ένα παρόμοιο μοτίβο σε δείγματα που έχουν συλλεχθεί στο Santa Clara County.
<br><br>
Αυτές οι ομάδες κρουσμάτων από τις συγκεκριμένες περιοχές ενδεχομένως προέκυψαν από ξεχωριστές εισαγωγές του ιού, σύμφωνα και με τη θέση τους στο φυλογενετικό δέντρο.
<!-- There is no right side text -->


<!-- ############ SOUTH AMERICA ############# -->
<!-- This is left-side text 10-->
# [Ενημερώσεις απο την Κεντρική και Νότια Αμερική](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Central%20America,South%20America&p=grid&r=country&c=country&legend=closed)
...
# [Στη Νότια Αμερική έχουμε δείγματα κυρίως από κρούσματα που συνδέονται με ταξίδια](https://nextstrain.org/ncov/2020-03-27?c=division_exposure&d=tree,map&f_region=Central%20America,South%20America&m=div&p=full&legend=open)
Δεν έχουμε ακόμα αρκετά γενετικά δεδομένα από τη Νότια Αμερική.
Από τα έως τώρα διαθέσιμα δεδομένα, τα περισσότερα αντιστοιχούν σε ταξιδιώτες.
Εδώ, το κάθε κρούσμα έχει χρωματιστεί ανάλογα με το ιστορικό έκθεσης στον ιό.
<br><br>
Μπορεί να παρατηρούμε ενδιαφέροντα μοτίβα στις σχέσεις των κρουσμάτων που δε συνδέονται με ταξίδια, ωστόσο δεν έχουμε ακόμα αρκετές πληροφορίες ώστε να εξάγουμε συμπεράσματα.
Οι προσπάθειες για αλληλούχηση συνεχίζονται και θα σας ενημερώσουμε όταν έχουμε μια καλύτερη εικόνα.
<!-- There is no right side text -->
...
# [Ενημερώσεις από την Ασία](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Asia&p=grid&r=country&c=country&legend=closed)
...
Ωστόσο, έχουμε αλληλουχίες από κρούσματα με ιστορικό ταξιδίου στο Ιράν.
<br><br>
Οι περισσότερες αλληλουχίες που έχουν ιστορικό ταξιδίου στο Ιράν ομαδοποιούνται, γεγονός που δείχνει ότι πολλά από τα περιστατικά του Ιράν προήλθαν από μία και μοναδική εισαγωγή του ιού στο Ιράν.
<br><br>
Στη βάση του δέντρου βλέπουμε μια νέα αλληλουχία από μια γυναίκα στο Πακιστάν που ταξίδεψε στο Ιράν.
Έχει ενδιαφέρον να δούμε ότι αυτό το κρούσμα βρίσκεται στη βάση των υπόλοιπων κρουσμάτων που αναφέρονται στο Ιράν, ωστόσο η δειγματοληψία του έγινε περίπου το ίδιο διάστημα.
<br><br>
Αυτό είναι σύμφωνο με πολλές πιθανές υποθέσεις. Όσο προκύπτουν περισσότερα δεδομένα, θα ενημερώνουμε τις αναλύσεις μας.
<!-- There is no right side text -->
...
# [Ενημερώσεις από την Αφρική](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Africa&p=grid&r=country)
...
# [Ενδείξεις για τοπική διασπορά στην Kinshasa, Congo](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_country=Congo&f_region=Africa&label=clade:A2a&p=grid&r=country)

Νέες αλληλουχίες από την Kinshasa της Λαϊκής Δημοκρατίας του Κονγκό μας παρέχουν ενδείξεις για πολλά και ξεχωριστά γεγονότα εισαγωγής του ιού.
<br><br>
Κάποιες από αυτές τις αλληλουχίες ανήκουν σε τοπικά κρούσματα από τα οποία ελήφθησαν δείγματα τις τελευταίες μέρες και ομαδοποιούνται πολύ στενά.
<br><br>
Το γεγονός αυτό μας υποδεικνύει ότι υπάρχει τοπική διασπορά του ιού τουλάχιστον από τις 15 Μαρτίου (που είναι η ημερομηνία δειγματοληψίας του πρώτου κρούσματος που φαίνεται να αποτελεί μέρος αυτής της αλυσίδας διασποράς) και πιθανώς αργότερα.
<br><br>
Η εξαιρετική δουλειά του INRB στην αλληλούχηση του γονιδιώματος του ιού από τα πρώτα κιόλας δείγματα, μας επιτρέπει να δούμε ότι υπάρχει διασπορά του ιού στην κοινότητα και σε άλλα μέρη που ακόμα δε γνωρίζουμε.
<!-- There is no right side text -->
...
# [Ενημερώσεις από την Ωκεανία](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Oceania&p=grid&r=country&c=country&legend=closed)
...
# [Τοπική διασπορά στο New South Wales](https://nextstrain.org/ncov/2020-03-27?Label=clade:A3&d=tree&f_division=New%20South%20Wales&label=clade:A3&p=full&r=location)

Νέες αλληλουχίες από την Αυστραλία υποδεικνύοτν ότι υπάρχει τοπική διασπορά του ιού στο New South Wales.
Πιθανών ο ιός να κυκλοφορεί στην περιοχή αυτή τουλάχιστον από τα τέλη Φεβρουαρίου.
...
#### ...ο καθένας ξεχωριστά
* Τηρείτε τα μέτρα κοινωνικής απόστασης, ιδιαιτέρως εάν ανήκετε σε ευπαθή ομάδα.
...
```auspiceMainDisplayMarkdown
## Takeaways
#### Τις επόμενες εβδομάδες θα παρακολουθούμε την επιδημία στην Ευρώπη ώστε να κατανοήσουμε εάν τα μέτρα κοινωνικής απομόνωσης έχουν ανακόψει τη διασπορά του ιού εκτός συνόρων.
<br><br>
#### Θα παρατηρούμε την κατάσταση στη Νότια Αμερική ώστε να εντοπίσουμε σημάδια τοπικής εξάπλωσης της επιδημίας, καθώς περισσότερες αλληλουχίες θα είναι διαθέσιμες.
<br><br>
#### Η επιδημία στις ΗΠΑ πιθανώς έχει ιδιαιτέρως περίπλοκα μοτίβα διασποράς, τόσο από εισαγωγές του ιού, όσο και από διασπορά ακόμα και σε απομακρυσμένα μέρη της χώρας. Βλέπουμε πως υπάρχουν πολλαπλές τοπικές αλυσίδες διασποράς στην Washington και την California.
<br><br>
#### Παρατηρούμε πως υπάρχει τοπική διασπορά του ιού στο New South Wales στην Αυστραλία.
<br><br>
#### Παρατηρούμε πως υπάρχει τοπική διασπορά στην Kinshasa στη Λαϊκή Δημοκρατία του Κονγκό. Δεν έχουμε ακόμα αρκετά δεδομένα ώστε να εκτιμήσουμε εάν ο ιός κυκλοφορεί τοπικά σε άλλα μέρη της Αφρικής.
```
