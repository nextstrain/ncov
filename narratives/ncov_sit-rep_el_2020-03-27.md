...
translators: Sotiris Salloumis, Sofia Paraskevopoulou
...
* [Πηγές](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-26?n=2).     
...
* [Ενημερώσεις απο τη Βόρεια Αμερική](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=6).  
* [Ενημερώσεις απο την Κεντρική και Νότια Αμερική](https://nextstrain.org/narratives/ncov/sit-rep/el/2020-03-27?n=10).  
...
<br><br>
Αν δεν είστε εξοικειωμένοι με φυλογενετικά δέντρα σας συνιστούμε να ελέγξετε το άρθρο ['Πώς να ερμηνεύσετε φυλογενετικά δέντρα'](https://nextstrain.org/narratives/trees-background/) και να επιστρέψετε όταν είστε έτοιμοι.
<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
