...
В некоторых последовательностях может не быть ни одной мутации - это означает, что эти последовательности идентичны корню (центру) этого дерева. 
...
На данный момент несколько случаев COVID-19 было зафиксированно в районе Сиэтла и США в целом. 
