...
どの症例の一部が検査および解析されるかは、地域と時間によって大きく異なります。
...
COVID-19 が突然爆発的に広がったように見えるかもしれません。
...
分かりやすい一例を、ワシントン州のデータに見ることができます。
...
これは、ワシントン州からユタ州への伝搬と一致していますが、直接ではなく、伝播経路の中に中間ステップがあった可能性もあります。
<br><br>
...
<br>
- 社会的距離をとおして地域の感染流行を制御することは:  
  - #FlattenTheCurve （流行曲線の抑制して）、医療システムに対する感染者の集中を防ぎます。  
  - 症例と死亡者の総数を減らします。  
  - 治療法とワクチンの開発の時間を稼ぎます。  
