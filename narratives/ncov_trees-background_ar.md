...
تسلسل الجينومات يجعلنا قادرين على تحليل اجزاء من شجرة الانتشار. في هذا المثال، مع ذلك، هناك ثلاث طفرات (معينات صغيرة) مشار لها على الشجرة.
...
<br><br>
قمنا بتلوين الشجرة بناءاً على على واحدة من هذه الطفرات -- في هذه الحالة استخدمنا كودون رقم ٣١٤ في "اطار القراءة ١ ب". 

لا يوجد سبب للظن بأن هناك افضلية لان تكون هذه الطفرة طفرة وظيفية (اي تسبب اي تغير وظيفي). انها بالضبط طفرات كهذه هي التي نستخدمها لتحديد العلاقات بيت التسلسلات ونبني منها الشجرة.
...
بعض التسلسلات يمكن ان لا تمتلك اي طفرات-- وهذا يعني انها 
متطابقة مع جذر (مركز) الشجرة
