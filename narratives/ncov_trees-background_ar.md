...
* [تحديد موعد بداية الانفجار الوبائي](https://nextstrain.org/narratives/trees-background?n=6)?  
...
اعتمادا على هذه الشجرة نستطيع الاستنتاج بان اي و بي مرتبطات جدا ببعضهما وان )دي و اي( مرتبطتان جدا ببعضهما، وأن )اي و بي( أكثر ارتباطا مع )سي( من ارتباطهما ب )دي و اي(.
