---
title: 新型冠状病毒（COVID-19）流行病学基因组分析状况报告2020-03-20.
authors:
  - Emma Hodcroft
  - Nicola Müller
  - Cassia Wagner
...
在这里，我们分析了723</tag>个公开共享的COVID-19基因组。通过将这些病毒基因组相互比较，我们可以推断COVID-19是如何在世界各地传播的。

我们在这份报告中强调，该病毒已被引入全球许多地区，并在各地传播。
为了了解COVID-19是否在当地传播以及传播到什么程度，以及疫情控制措施能如何减缓病毒传播，需要对当地的疫情动态有很好的了解。这需要进行广泛的检测才能实现。
这强调了快速检测的重要性，并且要把重点放在降低本地疫情的传播速度上。
...
* 本报告所引用的所有病例统计来自[WHO](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200318-sitrep-58-covid-19.pdf?sfvrsn=20876712_2)截至2020年3月20日发布的数字。
```
...
具体哪些病例得到了检测和测序可能会因地理区域和时间的不同而有很大差异。
此外，对疫情进行系统发生树的重构总是有一定程度的不确定性。
<br><br>
让我们来看几个例子。
...
从表面上来看，COVID-19可能像是突然爆发的。
可能对于许多人来说，这场疫情似乎是在一夜之间从一个世界其他地区的抽象问题变成了严重影响他们日常生活的事情。
<br><br>
但是，请记住，疫情已经酝酿了一段时间。病毒并不一定是被更频繁地输入至新的地方。
更可能的情况是，许多地方现在发现的本地疫情其实是好几周前输入的。
<br><br>
还没有发现本地疫情的地区应该现在就做好准备，开始监测疫情。 
...
有时，输入病例不会导致继发病例或本地疫情的爆发--特别是在原发病例得到快速检测和隔离的情况下。
然而，更多的时候，病毒是在未被发现的情况下在当地人群中传播，直到疫情达到相当大的规模。

下面是一个思维实验，展示了这种情况是如何在武汉发生的。y轴表示空间；x轴表示时间。阴影区域表示案例数。

"武汉的COVID-19病例从2019年11月的一个原发病例增加到2020年1月中旬的数千例，也就是在大约10周的时间里从最初的感染案例变成了广泛的社区传播。我们认为国与国之间的传播始于1月中旬。因此，从这个时间到3月下旬，我们有大约10周的关键时间来控制这些新生的疫情，以免它们发展扩大" [- Trevor Bedford](https://twitter.com/trvrb/status/1226241284207038464), 2020年2月

这些新的疫情可能会接着把病毒进一步传播到其他地方。
...
<br><br>
现在，在3月中旬(大约6周后)，我们可以看到这一地区的本地疫情正处于全面爆发中。仅从序列数据来看，如果假设病毒种群呈指数级增长，那么我们估计倍增率为3-6天。
<br>
...
我们还可以看到一个例子，这个例子可以说明一场一开始只是在本地爆发的疫情是如何输出至其他地点的。
靠近树顶(橙色)来自犹他州的样本位于华盛顿州疫情的主要分支内。
这与病毒是从华盛顿州传输到犹他州的推断是一致的，尽管传播链中也可能有一个或几个中间步骤。
<br><br>
我们不能确定这次输入是否会导致犹他州发生本地的疫情。
但是，如果病毒在这些输入事件后继续传播，我们预计将在接下来的4周内看到本地疫情发生。
<br><br>
这只是一个例子。
犹他州（或其他地区）可能还有其他的输入案例，因为没有被测序的原因，我们在树上是看不到的。
最重要的是，还没有发现本地疫情的地区应该现在就做好准备，开始监测疫情。

<!-- There is no right side text -->

<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 12 -->
# [疫情控制措施需要花费时间，但它可以拯救生命](https://nextstrain.org/ncov/2020-03-20)

按照同样的逻辑，很可能有许多我们还不知道的本地传播链存在。
<br><br>
这意味着，即使对于刚刚实施减少社交接触措施的地区，我们仍应预计在未来几周内病例数量会增加。
这样的增长并不表明这些措施不起作用。已经感染的人(可能还有他们的家庭成员)表现出症状、接受治疗和康复是需要时间的。我们还预计，随着检测覆盖人群的增加，报告的病例数量将会增加。
<br><br>
在这段时间内保持社交距离是至关重要的。如右图所示，干预措施到位后，病例数量会继续增加。但是，随着时间的推移，累积的病例数量将大大减少。
...
- 该病毒已多次传入全球许多地区.  
<br>
- 我们在许多地区看到了本地传播的证据；除此之外，我们预计之前的输入已经为多起本地疫情的爆发埋下了伏笔，这些疫情将在未来几周内变得明显。  
<br>
...
# 你能做些什么
## ...个人可以采取的行动
* 大幅度减少每天接触的人数，风险人群尤其要这样做（例如老年人和有既往疾病的人）。
...
# [科学贡献人员](https://nextstrain.org/ncov/2020-03-20?d=map&c=author)
