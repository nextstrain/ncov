...
但我们有许多有伊朗旅行史的样本序列。
<br><br>
大多数有伊朗旅行史的样本序列可以聚集到一起，这暗示了很多伊朗病例是由单次的输入事件所导致的爆发。
<br><br>
...
<br><br>
一些在数日之内采集到的本地样本聚成了一个紧密相关的基因簇。
<br><br>
这反映出当地的本地传播至少从3月15日起就开始了（3月15日是这个本地传播链中的样本最早被采集到的日期），还可能更早。
<br><br>
...
```auspiceMainDisplayMarkdown
## 总结
#### 接下来的几周内，我们将会观察欧洲疫情，看新施行的防疫决策是否能够阻碍跨境传播。
<br><br>
