...
abstract: "В этом отчете используются общедоступные геномные данные нового коронавируса (nCoV), полученные от GISAID и Genbank, для оценки уровней и моделей распространения вирусной эпидемии. Мы планируем выпускать обновленные отчеты о ситуации по мере того, как новые данные производятся и передаются. Этот сайт оптимизирован для отображения в настольных браузерах."
---

# [Сводка](https://nextstrain.org/ncov/2020-01-30/2020-01-30)

```auspiceMainDisplayMarkdown
## Резюме

Используя 42</tag> общедоступных генома нового коронавируса (нКоВ, nCoV), мы изучили генетическое разнообразие, чтобы сделать вывод о дате общего предка и скорости распространения.
Мы обнаружили что:
* 42</tag> отобранных генома очень похожи, и отличаются от консенсуса 0-7 мутациями
* Эта нехватка генетического разнообразия имеет объяснение тому, что вспышка произошла либо от единственного внедрения в человеческую популяцию, либо от небольшого количества передач очень похожих вирусов от животных к человеку.
* Это событие, скорее всего, произошло в ноябре или начале декабря 2019 года.
* С этого момента происходило постоянное распространение от человека к человеку, что привело к наблюдаемым случаям.
* Используя оценки общего количества случаев из Имперского колледжа Лондона (Imperial College London) в несколько тысяч случаев, мы определяем репродуктивное число между 1,8 и 3,5, что указывает на быстрый рост в период с ноября по январь.
```
...
Коронавирусы (КоВ, CoV) являются представителями разнообразного вида вирусов, состоящих из одноцепочечной (+)РНК, которые в прошлом вызывали респираторные инфекции у людей.
Некоторые варианты коронавирусов связаны со вспышками, другие постоянно циркулируют и вызывают, в основном, легкие респираторные инфекции (например простуду).
...
Существует четыре "сезонных" коронавируса, которые обычно заражают людей каждый год.
По сравнению с ТОРС-КоВ (SARS-CoV) эти сезонные штаммы коронавируса являются [«гораздо более распространенными, гораздо менее тяжелыми и частыми причинами гриппоподобное состояний»](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5820427/).
Фактически [5](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2879166/) - [12% всех случаев](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5820427/) гриппоподобных состояний дают положительный результат на коронавирусы - они довольно распространены и приводят к миллионам лёгких случаев инфекций ежегодно.
...
Из-за способности ТОРС (SARS) распространяться между людьми и высокой смертности, SARS (или вирус похожий на ТОРС (SARS)) объявлен ВОЗ [глобальной угрозой для общественного здравоохранения](https://www.who.int/whr/2007/overview/en/index1.html).
...
По состоянию на 30 января [было зарегистрировано](https://en.wikipedia.org/wiki/2019%E2%80%9320_outbreak_of_novel_coronavirus_(2019-nCoV)) более 7 914 случаев и 170 случаев смерти.
Еще слишком рано, чтобы знать смертность от случаев, но первые признаки того, что он значительно ниже, чем ТОРС-КоВ (SARS-CoV).
Число случаев резко возрастает отчасти из-за усиления наблюдения и тестирования.

В то время как вспышка, похоже, была сосредоточена в Ухане, который сейчас [находится на карантине](https://twitter.com/PDChina/status/1220060879112282117), вирус распространился по всему Китаю и за его пределами, включая Гонконг, Сингапур, Японию и Таиланд, а также в Европу, Северную Америку, Южную Азию, на Ближний Восток и в Австралию. Сообщалось об ограниченной местной передаче за пределами Китая.
...
Вполне вероятно, что были другие промежуточные передачи через животных до заражения человека.
Там нет никаких доказательств змей в качестве посредника.

#### Нарративы Nextstrain

Следующие страницы содержат анализ, выполненный с использованием [Nextstrain](https://nextstrain.org).
Прокрутка левой боковой панели покажет абзацы текста с соответствующей визуализацией геномных данных с правой стороны.

Получить полные геномы нового и большого РНК-вируса так скоро - это замечательное достижение.
Этот анализ стал возможным благодаря быстрому и открытому обмену геномными данными и интерпретацияии учеными всего мира (см. Последний слайд для с данными по авторству секвенирования).
```
...
Патогены распространяются посредством быстрой репликации в одном хозяине-носителе хосте с последующей передачей на хозяина-носителя.
Эпидемия может развиться только тогда, когда одно заражение приводит к более чем одному последующему заражению.

По мере того как патоген размножается и распространяется, его геном требует многократной репликации, и в геноме будут накапливаться случайные мутации (ошибки копирования).
Такие случайные мутации могут помочь отследить распространение возбудителя и узнать о путях его передачи и динамике.
...
На рисунке выше показан эскиз дерева передачи с подмножеством выборок, которые были отобраны (показаны синим цветом).
...
Ниже мы видим иллюстрацию с филогенетическим деревом слева, где мутации показаны в виде цветных кружков. Справа - соответствующие последовательности, с мутациями, показанными как цветные круги.
Мы можем видеть, что последовательности, которые имеют общюю мутацию, объединяются.
Когда последовательности связанны вертикальной линией, как например A и B, это означает, что между ними нет различий - их последовательности идентичны.

Когда последовательность располагается на длинной строке сама по себе, как например C или E, это означает, что она имеет уникальные мутации, которых нет в других последовательностях. Чем длиннее линия, тем больше мутаций.
А и В также имеют уникальные мутации (зеленый кружок), которые не разделяются другими последовательностями, но они идентичны друг другу.
...
Вы можете увидеть, сколько мутаций имеет ветка, наведя на нее указатель мыши.
```

# [Филогенетический анализ](https://nextstrain.org/ncov/2020-01-30?m=div&d=tree)

Здесь мы представляем филогению из 42</tag> штаммов nCoV, которые были общедоступными.
Информация о том, как был выполнен анализ, доступна [в этом репозитории GitHub](github.com/nextstrain/ncov).

<br>

Цвета обозначают регион внутри страны или штат США, а ось X представляет дивергенцию нуклеотидов.
...
Некоторые из различий, наблюдаемых в этих последовательностях, могут быть ошибками последовательности, а не фактическими мутациями.
Вставки, делеции и различия на концах генома, скорее всего, будут ошибками, и поэтому мы замаскировали их для целей этого анализа.

# [Филогенетическая интерпретация](https://nextstrain.org/ncov/2020-01-30?m=div&d=tree)

В настоящее время мы видим небольшое генетическое разнообразие в последовательностях нКоВ (nCoV), при этом 11</tag> из 42</tag> последовательностей не имеют уникальных мутаций.

<br>

Низкое генетическое разнообразие между этими последовательностями позволяет предположить, что самый последний общий предок всех последовательностей nCoV был относительно недавним, поскольку мутации накапливаются медленно по сравнению с другими РНК-вирусами со скоростью около 1-2 мутаций в месяц для коронавирусов.
Как правило, повторные интродукции из естественного резервуара демонстрируют значительное разнообразие (это относится к Лихорадкe Ласса (Lassa), Эболе (Ebola), ТОРС-КоВ (SARS-CoV) и птичьему гриппу (avian flu)).
...
Мы начинаем видеть группы последовательностей, которые имеют общие мутации.
...
Последовательности в этих кластерах, как правило, взяты из более поздних образцов, что позволяет предположить, что вирус начал накапливать мутации по мере распространения в Ухани и впоследствии в другие города.
...
Три мутации, обнаруженные в этом кластере, также присутствуют в изоляте Аризона, США, и две мутации обнаружены в трех других изолятах США.
...
Две французские последовательности [принадлежат к одному семейству](https://www.thelocal.fr/20200129/coronavirus-in-france-what-you-need-to-know) - Китайской паре из Ухани.
...
Предыдущее исследование связанного коронавируса предполагает, что эти вирусы накапливают в своем геноме от 1 до 3 изменений в месяц (с частотой от 3 &times; 10<sup>-4</sup> до 1 &times; 10<sup>-3</sup> на участок в год).
...
предполагая звездообразную структуру филогении вместе с пуассоновским распределением мутаций во времени, чтобы оценить время самого последнего общего предка ('TMRCA') секвенированных вирусов.
...
Используя весь набор данных, конвейер анализа nextstrain оценивает, что общий предок, скорее всего, существовал между концом ноября и началом декабря 2019 года.

Существует [подтвержденный случай в Ухане с датой начала 1 декабря 2019 года](https://twitter.com/trvrb/status/1220749265380593664), который может установить верхнюю границу даты ближайшего общего предка.
...
Несмотря на значительную неопределенность, наше лучшее предположение остается концом ноября - началом декабря.

```

# [Оценка темпа роста](https://nextstrain.org/ncov/2020-01-30?d=tree)
...
Ученые из Имперского колледжа Лондона использовали количество случаев, наблюдаемых за пределами Китая, для оценки [общего числа случаев](https://www.imperial.ac.uk/mrc-global-infectious-disease-analysis/news--wuhan-coronavirus/) и предположил, что к 2020-01-22 было зарегистрировано не менее нескольких тысяч случаев.
С учетом того, что с тех пор появилось еще больше экспортированных случаев, и продолжающeгося роста числа подтвержденных случаев в Китае, мы должны ожидать, что на сегодняшний день должно быть не менее 50000 случаев.
...
Мы хотели бы отметить удивительную и своевременную работу, проделанную всеми учеными, причастными к этой вспышке, но особенно теми, кто работает в Китае.
