---
title: 新型コロナウイルス拡散の遺伝的解析と状況報告2020-03-27.
authors:
  - Sidney M. Bell
  - Nicola Müller
  - Emma Hodcroft
...
ここでは、公に共有されている 1,495 種のゲノムを分析しました。これらのウイルスのゲノムを相互に比較することにより、COVID-19 が世界中をどのように移動しているか、局所的にどのように拡散しているかを特徴付けることができます。今週の更新では、次の内容を報告します:  

**ヨーロッパ**  
* 私たちはヨーロッパ内でサンプルの強い混在が続いていることを確認しています。このことはウイルスがここ3-5週の間に国境を超えて移動し続けていたことを示しています。施策が効果を発揮するまでに時間がかかるため、国ごとの症例のクラスタリングがさらに進む可能性があります。

**北米**   
* 米国内では伝染のパターンは複雑です: 国の反対側で収集されたサンプルでも強い関連性を示しています。
* ワシントン州は少なくとも2つの独立した伝搬(1つ目は中国、2つ目はヨーロッパの可能性)があり、2つの別々な伝染の連鎖が生じています。
* いくつかの州で局所的に伝染している可能性があるという証拠がありますが、その中でも特にカリフォルニア州でははっきりとしています。

**中南米**
* 今週南アメリカから新たに遺伝子配列を入手しましたが、収集はまだまばらです。この地域では、入手したデータ以上に COVID の活動が活発であるかもしれませんが、確かなことは言えません。

**アジア**  
* イランから COVID-19 の国外への最近の伝搬があったという証拠を発見しました。

**アフリカ**  
* 系統解析は、コンゴ共和国、 Kinshasa 内で直近11日間以上、地域的な伝染があった可能性について示唆しています。 
* 今週新たにアフリカからの遺伝子配列を入手しましたが、収集は未だにまばらです。この地域では、入手したデータ以上に COVID の活動が活発であるかもしれません。

**オセアニア**
* オーストラリア、New South Wales 州の遺伝子データには、地域的な伝染の証拠があります。
```
...
COVID-19 とそれを引き起こすウイルスである SARS-CoV-2 を理解するために、読む価値のある資料を用意しました。
この情報は、このレポートで提示するデータの解釈を容易にします。
<br><br>
系統樹に詳しくない場合は、[系統発生の読み方](https://nextstrain.org/narratives/trees-background/ja)の内容を確認した上で、次のページに進むことをお勧めします。
<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
...
# [収集されたデータについて](https://nextstrain.org/ncov/2020-03-27?c=country&r=country&d=map&p=grid&legend=closed)
現在、6 大陸の48 か国で採取されたサンプルの遺伝子配列があります。これは信じられないほどの成果です。流行の最中に未知の大型RNAウイルスの遺伝子を解析することは難しく、世界中の科学者や医師による信じられないような作業とタイムリーなデータの共有があって初めて可能になりました。
<br><br>
このデータにより、多くの有用な特性を推測し、流行の広がりをリアルタイムで追跡することができますが、結論は利用可能なデータによって制限されることに留意して下さい。
<br><br>
例えば、この地図を見ると、南半球からの遺伝子配列が非常に少ないです。
これは、COVID-19 がこれらの地域で流行していないため、またはこれらの症例を理解することが重要ではないためではありません。むしろ、これらの地域からの入手可能なデータが少ないことを意味します。
マップ上の各円のサイズは、実際の流行の広がり度合いを示すというよりも、そのエリアにおいて利用可能なデータ量を示しています。
...
# [ヨーロッパに関するアップデート](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Europe&p=grid&r=country&c=country)
...
# [直近3-5週間の持続的、越境的拡散](https://nextstrain.org/ncov/2020-03-27?c=country&d=tree,map&dmin=2020-03-06&f_region=Europe&p=full&r=country&legend=closed)

ここでは、過去3週間にヨーロッパで採取されたサンプルを、単離された国別に色分けして示しています。
注目すべきは、国別の小さなクラスターがいくつか見られる一方で、様々な国からのサンプルの間で非常に多くの混合が見られることです。
<br><br>
このことは、3-5 週間の間に国境を超えて、持続的な拡散があったことを示唆しています。
<br><br>
このような地理的なクラスタリングは、地域間の移動を制限する最近の施策によって、さらに強くなる可能性があります。
<!-- There is no right side text -->

<!-- ##### slide break ##### -->
<!-- This is left-side text 5-->
# [アイスランドからの新たな遺伝子配列](https://nextstrain.org/ncov/2020-03-27?c=division_exposure&d=tree,map&f_country=Iceland&legend=open)

アイスランドから多くの新しい配列を入手しました。
各症例のウイルスとの接触歴(既知の場合)で色分けをすると、これらの症例の多くは最近の渡航者由来であることがわかります。
我々はこれらの新しいデータの解析に懸命に取り組んでおり、そこからわかったことを次週報告する予定です。
<!-- There is no right side text -->


<!-- ############ NORTH AMERICA ############# -->
<!-- This is left-side text 6-->
# [北米に関するアップデート](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=North%20America&p=grid&r=location&legend=closed)
...
# [米国内の拡散は複雑でよく理解されていない](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_division=Connecticut&label=clade:B1&m=div&p=full)
米国内だけを見ても、感染の拡散パターンは非常に複雑です。
<br><br>
例えば、コネチカット州の最近のサンプル (選択された先端) はワシントン州からのサンプル (色の薄い部分) の祖先であり、同時に混在しています。
確かな結論を導くにはより多くのデータが必要ですが、このことは米国内のかなり距離のあるところの間でさえ、最近は感染が広まっていたことを示唆しています。
<br><br>
これは、米国中で起きている拡散のパターンが、現在入手できているデータが示すしているよりはるかに、複雑であることを強調しています。
追加のデータがあれば、各州の対応が非常に異質であることを背景に、相互に関連していると思われる全米的な感染拡大が、どのように発生しているかを理解するのに役立ちます。
<!-- There is no right side text -->


<!-- ##### slide break ##### -->
<!-- This is left-side text 8-->
# [ワシントン州での複数の連鎖的な感染拡大](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_country=USA&f_division=Washington&p=full&r=location)

ワシントン州を見てみると、少なくとも2つの個別の局所的な感染拡大のクラスターがあることがわかります。
<br><br>
しかし、2つのクラスターはそれぞれ由来が異なります: 1つ目は中国からのサンプルともっとも強く関連がありますが、2つ目はヨーロッパのサンプルと最も強く関連があります。その間に未収集のサンプルがある場合、これらの伝搬が間接的であった可能性があります。
<br><br>
<!-- There is no right side text -->
...
# [カリフォルニア州での2つの局所的拡散の可能性](https://nextstrain.org/ncov/2020-03-27?c=location&f_country=USA&f_division=California&label=clade:A7&p=full&r=location&m=div&d=tree,map)

米国の他の場所でも同様のパターンをみることができます。
<br><br>
ここでは、北カリフォルニアの Solano 郡 のサンプルを見ています。
収集された日付は違いますが、互いに非常に強く関連しています。
<br><br>
カリフォルニア州の利用可能なデータは限られているため、確かな結論を出すことはできませんが、この予備的な証拠は Solano 郡内での地域流行と一貫性があります。
<br><br>
系統樹の他の部分、Santa Clara 郡で単離されたサンプルでも同様のパターンが見られます。
<br><br>
系統樹の相対的な位置にもとづくと、これらの郡の症例のクラスターは別々の伝搬である可能性があります。
<!-- There is no right side text -->


<!-- ############ SOUTH AMERICA ############# -->
<!-- This is left-side text 10-->
# [中南米に関するアップデート](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Central%20America,South%20America&p=grid&r=country&c=country&legend=closed)
...
# [南アメリカの主に渡航関連する症例](https://nextstrain.org/ncov/2020-03-27?c=division_exposure&d=tree,map&f_region=Central%20America,South%20America&m=div&p=full&legend=open)
南米からの遺伝子配列データはまだ多くありません。
利用可能なデータの殆どは、渡航者からのものです。
ここでは、既知のウイルスとの接触歴によって各症例が色付けされています。
<br><br>
潜在的に興味深いパターンが渡航と関係のない症例で現れ始めていますが、結論づけるには十分な証拠がまだありません。
遺伝子配列解析の取り組みは着実に進んでおり、状況が明確になり次第報告します。
<!-- There is no right side text -->
...
# [アジアに関するアップデート](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Asia&p=grid&r=country&c=country&legend=closed)
...
しかし、イランへの渡航が報告されている多くの症例からの配列遺伝子配列があります。
<br><br>

イランへの渡航歴があるほとんど遺伝子配列はグループ化でき、このことは多くのイランでの症例が一度きりの伝搬が由来となっていることを示唆しています。
<br><br>
系統樹の一番下に、イランへの渡航歴があるパキスタンでの女性の新しい遺伝子配列があります。
興味深いことに、この症例は把握している他のイランからの症例とはグループを形成しませんが、同時期に収集されていました。
<br><br>
このことはいくつかの考えられる仮説と合致しますが、データが増え次第、私たちの解析を更新します。
<!-- There is no right side text -->
...
# [アフリカに関するアップデート](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Africa&p=grid&r=country)
...
# [コンゴ、Kinshasa での局所的拡散の証拠](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_country=Congo&f_region=Africa&label=clade:A2a&p=grid&r=country)
コンゴ共和国の Kinshasa からの新たな遺伝子配列は、複数の別々な伝搬の証拠を示しています。
<br><br>
これらの遺伝子配列のいくつかは、数日間に渡って収集された局所的な症例で、非常に強く関連したグループを形成しています。
<br><br>
このことは、少なくとも3月15日(局所的な連鎖的拡散の一部であると考えられる一番最初の症例のサンプル収集日)から、あるいはそれ以前から継続して、地域的な拡散があったことと一致します。
<br><br>
ウイルスを初期のサンプルからシーケンシングするINRBの優れた取り組みにより、目に見えないまま多くの他の場所で進行している、コミュニティでの拡散について知ることができます。
<!-- There is no right side text -->
...
# [オセアニアに関するアップデート](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_region=Oceania&p=grid&r=country&c=country&legend=closed)
...
# [New South Wales 州での局所的な拡散](https://nextstrain.org/ncov/2020-03-27?Label=clade:A3&d=tree&f_division=New%20South%20Wales&label=clade:A3&p=full&r=location)

オーストラリアからの新規の遺伝子配列は、New South Wales 州で局所的な拡散があることの証拠を示しています。
遅くとも2月末からこの地域ではウイルスが蔓延している可能性があります。
...
#### ...個人が出来ること
* 特に感染の影響を受けやすい集団の場合、社会的な距離を保つことを厳格に実践してください。
...
```auspiceMainDisplayMarkdown
## まとめ
####  私たちはこれから数週の間、新たな施策により国境を越えた感染が食い止められたことを示す兆候がないか、欧州での感染拡大を注視していきます。
<br><br>
#### 南米の状況については、より多くの遺伝子配列が入手可能になった時点で、局所的な拡散の兆候がないかどうかを注視していく予定です。
<br><br>
####  米国での感染拡大は、距離的に離れている場所同士でさえ、伝搬と拡散の両方の店で複雑な伝染パターンがあるようです。私たちはワシントン州とカリフォルニア州で連鎖的な地域の伝染が複数あるという証拠を発見しました。
<br><br>
#### オーストラリアの New South Wales 州で地域的な伝染があるということがわかりました。
<br><br>
#### コンゴ共和国、Kinshasa で局所的な拡散がることがわかりました。アフリカの他の場所で地域的にウイルスが蔓延しているかどうかを評価するには、まだデータが十分ではありません。
```
...
# [分析データの詳細](https://nextstrain.org/ncov/2020-03-27?d=map&c=author)
