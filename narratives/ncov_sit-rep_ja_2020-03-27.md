...
追加のデータがあれば、、各州の全く不均一な反応を背景とした、内的には密接に繋がりのある国内での感染拡大がどのように発生しているかを理解するのに役立ちます。
<!-- There is no right side text -->
...
しかい、イランへの渡航が報告されている多くの症例からの配列遺伝子配列があります。
<br><br>
...
# [New South Wales での局所的な拡散](https://nextstrain.org/ncov/2020-03-27?Label=clade:A3&d=tree&f_division=New%20South%20Wales&label=clade:A3&p=full&r=location)

オーストラリアからの新規の遺伝子配列は、New South Wales で局所的な拡散があることの証拠を示しています。
