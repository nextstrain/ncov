...
* [Справочные ресурсы](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=2).
* [Об этих данных](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=3).  
* [Последние данные по Европе](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=4).  
* [Последние данные по Северной Америке](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=7).  
* [Последние данные по Центральной и Южной Америке](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=11).  
* [Последние данные по Азии](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=13).  
* [Последние данные по Африке](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=15).  
* [Последние данные по Океании](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=17).  
* [Что вы можете предпринять](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=19).  
* [Благодарности](https://nextstrain.org/narratives/ncov/sit-rep/ru/2020-03-27?n=20).  
...
<br><br>
Например, карта показывает очень немногочисленные последовательности с южной части мира. Это происходит НЕ из-за того, что COVID-19 не циркулирует в этих местностях, или потому, что эти случаи неважны для понимания, мы попросту не обладаем достаточными данными из этих регионов. Размер каждого круга на карте соответствует количеству доступной информации, а не реальному размеру вспышки.
...
# [Распространение через границы, продолжающееся последние 3-5 недель](https://nextstrain.org/ncov/2020-03-27?c=country&d=tree,map&dmin=2020-03-06&f_region=Europe&p=full&r=country&legend=closed)

Здесь мы показываем образцы, собранные в Европе за последние 3 недели и раскрашенные в соответствии со странами, в которых их выделили. Примечательно, что несмотря на то что некоторые мелкие кластеры принадлежат конкретным странам, также в большой степени наблюдается перемешивание между изолятами из разных стран.
<br><br>
Это говорит о том, что распространение вируса за пределы государственных границ продолжалось последние 3-5 недель.
<br><br>
...
Раскрашивая по истории воздействия каждого случая (если известно), мы видим, что многие из этих случаев происходят от недавних путешествий. Мы прилагаем все усилия, чтобы проанализировать все эти новые данные, и сообщим о наших выводах на следующей неделе.
<!-- There is no right side text -->
...
# [Передача на территории США является комплексной и недостаточно изученной](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_division=Connecticut&label=clade:B1&m=div&p=full)

Даже внутри США схемы передачи очень сложны.
<br><br>
Например, недавние образцы из Коннектикута (выделенные концы ветвей) одновременно являются предками для образцов из штата Вашингтон (невыделенные концы ветвей) и в то же время перемешаны с ними.  
Несмотря на необходимость большего количества данных для конкретных выводов, это говорит о недавней передаче даже между весьма удаленными частями страны.
<br><br>
Это подчеркивает тот факт, что пути передачи на территории США куда более сложные, чем представлено в доступных данных.
Дополнительные данные помогут нам осознать тот факт, что глубоко взаимосвязанная национальная эпидемия уже наверняка разыгрывается на фоне чрезвычайно разнородных мер, предпринимаемых разными штатами.
<!-- There is no right side text -->
...
Взглянув на случаи заболеваний в штате Вашингтон, мы видим, что существуют как минимум 2 отдельных местных вспышечных кластера.
<br><br>
...
# [Вероятны две местные цепи передач в Калифорнии](https://nextstrain.org/ncov/2020-03-27?c=location&f_country=USA&f_division=California&label=clade:A7&p=full&r=location&m=div&d=tree,map)
...
<br><br>
На основании их соответствующих позиций на дереве, эти группы случаев из двух округов, вероятно, произошли в результате независимых заносов.
<!-- There is no right side text -->
...
У нас пока нет достаточного количества данных секвенирования из Южной Америки.
Из доступных данных: большинство образцов - от путешественников.
...
Усилия по секвенированию набирают обороты, и мы вернемся с докладом, как только ситуация прояснится.
<!-- There is no right side text -->
...
Интересно, что этот случай попадает вне группы по отношению к остальным известным случаям из Ирана, однако, соответствующий образец был собран приблизительно в то же время.
<br><br>
...
# [Свидетельства локальной передачи в Киншаса, Конго](https://nextstrain.org/ncov/2020-03-27?d=tree,map&f_country=Congo&f_region=Africa&label=clade:A2a&p=grid&r=country)

Новые последовательности из Киншаса в Демократической Республике Конго показывают признаки нескольких отдельных случаев проникновения вируса.
<br><br>
Некоторые из этих последовательностей образуют группу очень тесно взаимосвязанных локальных случаев, которые были отобраны в течение нескольких дней.
<br><br>
...
<br><br>
Отличная работа Национального Института Биомедицинских Исследований (INRB) по выделению вируса из ранних образцов позволяет нам видеть передачу в общинах, которая скрыта во многих других местах.
...
<br><br>
#### Мы будем следить за ситуацией в Южной Америке на наличие признаков местной передачи по мере того, как все больше последовательностей становятся доступными.
<br><br>
####  Эпидемия в США, вероятно, обладает очень сложной структурой передач, включающей как импортирование, так и распространение между различными частями страны. У нас есть доказательства существования множественных местных цепей передач в штатах Вашингтон и Калифорния.  
<br><br>
...
# [Благодарности](https://nextstrain.org/ncov/2020-03-27?d=map&c=author)
...
# [Детальные благодарности](https://nextstrain.org/ncov/2020-03-27?d=map&c=author)
