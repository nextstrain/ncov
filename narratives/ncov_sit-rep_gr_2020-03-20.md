---
title: Γενομική ανάλυση της εξάπλωσης του COVID-19. Αναφορά κατάστασης 2020-03-20.
authors:
  - Emma Hodcroft
  - Nicola Müller
  - Cassia Wagner
...
translatorLinks:
date: "2020 March 20"
data: "https://nextstrain.org/ncov/2020-03-20?legend=closed&d=map&legend=closed"
abstract: "Αυτή η αναφορά χρησιμοποιεί δεδομένα που είναι δημοσίως διαθέσιμα για την ιχνηλάτηση της εξάπλωσης του COVID-19. Οι αναφορές ανανεώνονται σε εβδομαδιαία βάση."
---
...
# [Περιεχόμενα](https://nextstrain.org/ncov/2020-03-20?d=tree,map&p=grid)

* [Πηγές πληροφόρησης](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=2).     
* [Μια σημείωση σχετικά με τις δειγματοληψίες](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=3).
* [Αλληλουχίες και ιστορικό ταξιδίων](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=6).
* [Εισαγωγή του COVID-19 σχεδόν σε όλες τις χώρες](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=8).
* [Πώς αναπτύσσονται και επεκτείνονται οι εξάρσεις](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=9).
* [Πώς αναπτύχθηκε η επιδημία της Washington](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=10).
* [Πώς επεκτάθηκε η επιδημία της Washington](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=11).
* [Πώς μεταβάλλονται οι αριθμοί κρουσμάτων όταν εφαρμόζονται μέτρα κοινωνικής απόστασης](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=12).
* [Τί μπορείτε να κάνετε](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=13).
* [Επιστημονικές ευχαριστίες](https://nextstrain.org/narratives/ncov/sit-rep/2020-03-20?n=14).

<!-- This is right-side text -->
```auspiceMainDisplayMarkdown
# Γενική περίληψη

Εδώ παρουσιάζουμε την ανάλυση που προέκυψε από 723 δημοσίως διαθέσιμα COVID-19 γονιδιώματα. Συγκρίνοντάς τα μεταξύ τους, μπορούμε να αντιληφθούμε πώς ο COVID-19 μετακινείται στην υφήλιο.

Σε αυτή την αναφορά, τονίζουμε ότι ο ιός εισήχθη και κυκλοφορεί σε πολλά μέρη του κόσμου.
Γνωρίζοντας εάν και σε ποιο βαθμό ο COVID-19 κυκλοφορεί τοπικά και πώς τα ενδεχόμενα μέτρα για τον περιορισμό του μπορούν να επιβραδύνουν την εξάπλωση, προϋποθέτει μια καλή γνώση της δυναμικής της επιδημίας του ιού τοπικά. Αυτό με τη σειρά του προϋποθέτει εκτενείς ελέγχους.
Το γεγονός αυτό καταδεικνύει τη σημασία των εντατικών ελέγχων ώστε να καθυστερήσουν τα γεγονότα μετάδοσης του ιού.

Στην αναφορά αυτής της εβδομάδας περιλαμβάνονται:

* Αποδεικτικά στοιχεία σχετικά με εισαγωγές που προήλθαν από ταξιδιώτες σε πολλά μέρη του κόσμου.
* Πολλά μέρη με πρόσφατες εισαγωγές του ιού μπορούν να αναμένουν ότι τα κρούσματα θα επεκταθούν σε ένα διάστημα 4-8 εβδομάδων. Αυτά τα μέρη πρέπει τώρα να προετοιμαστούν.
* Πολλά μέρη τα οποία πρόσφατα υιοθέτησαν μέτρα κοινωνικής απόστασης μπορούν να αναμένουν αύξηση της συσσώρευσης κρουσμάτων σε σύντομο χρόνο, όμως τα νέα κρούσματα θα πιάσουν πλατώ και θα μειωθούν σε βάθος χρόνου.
* Οι έλεγχοι σε ασθενείς αλλά και σε αυτούς που ξεπέρασαν την ασθένεια θα είναι ζωτικής σημασίας στην αντιμετώπιση της επιδημίας.
```
...
# [Πηγές πληροφόρησης σχετικά με τον COVID-19](https://nextstrain.org/ncov/2020-03-20)
Έχουμε ετοιμάσει ορισμένες πηγές πληροφόρησης οι οποίες προσφέρονται ώστε κανείς να εξοικειωθεί με τον COVID-19 και τον ιό που προκαλεί την ασθένεια, τον SARS-CoV-2.
Αυτές οι πληροφορίες θα κάνουν πιο εύκολη την κατανόηση των δεδομένων που παρουσιάζουμε. Εάν δεν είστε εξοικειωμένοι με τα φυλογενετικά δέντρα, σας ενθαρρύνουμε να δείτε την ενότητα ['How to Read Phylogenies' narrative](https://nextstrain.org/narratives/trees-background/) και να επιστρέψετε όταν είστε έτοιμοι.
...
* Περίληψη της πανδημίας του ιού SARS-CoV-2 [Wikipedia](https://el.wikipedia.org/wiki/%CE%A0%CE%B1%CE%BD%CE%B4%CE%B7%CE%BC%CE%AF%CE%B1_%CE%BA%CE%BF%CF%81%CE%BF%CE%BD%CE%BF%CF%8A%CE%BF%CF%8D_2019%E2%80%9320).
* Όλοι οι αριθμοί κρουσμάτων που αναφέρονται εδώ προκύπτουν από τον [ΠΟΥ](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200318-sitrep-58-covid-19.pdf?sfvrsn=20876712_2) με ημερομηνία 20-03-2020.
```

<!-- ############ SLIDE BREAK ############# -->

<!-- This is left-side text 3 -->
# [Μια σημείωση σχετικά με τις δειγματοληψίες](https://nextstrain.org/ncov/2020-03-20?c=country&r=country&d=map&p=grid&legend=closed)
Αυτή τη στιγμή έχουμε αλληλουχίες από 36 χώρες σε 6 ηπείρους. Αυτό είναι ένα αξιόλογο κατόρθωμα -- η αλληλούχηση ενός άγνωστου ιού με μεγάλο RNA γονιδίωμα εν μέσω πανδημίας είναι δύσκολη και είναι η εξαιρετική δουλειά και ο συνεχής διαμοιρασμός δεδομένων από επιστήμονες και γιατρούς σε όλο τον κόσμο που την καθιστούν δυνατή.

<br><br>
Τα δεδομένα αυτά μας επιτρέπουν να κατανοήσουμε πολλά και χρήσιμα χαρακτηριστικά της πανδημίας και να ιχνηλατίσουμε την εξάπλωσή της σε πραγματικό χρόνο. Ταυτόχρονα όμως είναι σημαντικό να τονίσουμε ότι τα συμπεράσματά μας είναι περιορισμένα λόγω της περιορισμένης διαθεσιμότητας δεδομένων.
Από τον πραγματικό αριθμό κρουσμάτων, μόνο ένα μέρος υποβάλλεται σε έλεγχο. Από αυτά που ελέγχονται, μόνο ένα υποσύνολο δειγμάτων υποβάλλεται σε αλληλούχηση.
Το υποσύνολο των κρουσμάτων που υπόκειται σε έλεγχο διαφέρει αρκετά στις διάφορες γεωγραφικές τοποθεσίες αλλά και μέσα στο χρόνο.
Επίσης, οι φυλογενετικές αναλύσεις της πανδημίας συνδέονται πάντα με ένα βαθμό αβεβαιότητας.
<br><br>
...
# [Μερικές περιοχές δεν αντιπροσωπεύονται στα δεδομένα αυτά](https://nextstrain.org/ncov/2020-03-20?c=country&d=map&f_region=Central%20America,Oceania,South%20America,Africa&legend=closed&p=full&r=country)
Ο χάρτης δείχνει πολύ λίγες αλληλουχίες από τη νότια περιοχή της υφηλίου. Για παράδειγμα, έχουμε αλληλουχίες για μόλις 4 από τις 25 χώρες της Λατινικής Αμερικής στις οποίες [ο ΠΟΥ αναφέρει](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200319-sitrep-59-covid-19.pdf?sfvrsn=c3dcdef9_2) ότι υπάρχουν κρούσματα του COVID-19. Αυτό δε συμβαίνει επειδή ο COVID-19 δε βρίσκεται στις περιοχές αυτές ή επειδή αυτά τα περιστατικά δεν είναι τόσο χρήσιμα στην κατανόηση της πανδημίας, αλλά επειδή δεν υπάρχουν πολλά δεδομένα διαθέσιμα από τις περιοχές αυτές.
<br><br>
<!-- There is NO right-side text -->
...
# [Άλλες περιοχές υπερ-αντιπροσωπεύονται στα δεδομένα αυτά](https://nextstrain.org/ncov/2020-03-20?c=country&d=map&f_region=Europe&legend=closed&p=full&r=country)
Σε άλλες περιοχές, όπως για παράδειγμα στην Ολλανδία, υπάρχει ένας τεράστιος αριθμός αλληλουχιών, σε σχέση με το συνολικό αριθμό κρουσμάτων, που είναι διαθέσιμες.
<br><br>
Επομένως, όταν διαβάζετε αυτή την αναφορά, έχετε στο νου σας ότι το μέγεθος κάθε κύκλου στο χάρτη αντιπροσωπεύει το μέγεθος των δεδομένων που είναι αυτή τη στιγμή διαθέσιμα από την εκάστοτε περιοχή και όχι το πραγματικό μέγεθος της επιδημίας. Μπορείτε [εδώ να διαβάσετε](https://nextstrain.org/narratives/trees-background?n=8) για το πώς το γεγονός αυτό επιδρά στα συμπεράσματα που εξάγονται σχετικά με την εξάπλωση του ιού.
<br><br>
...
# [Οι πληροφορίες από τις αλληλουχίες μπορούν να διασταυρώσουν ιστορικά ταξιδίων](https://nextstrain.org/ncov/2020-03-20?legend=open&c=division_exposure&label=clade:A1a&d=tree)

Ο εντοπισμός της περιοχής όπου ένα περιστατικό μολύνθηκε με τον ιό είναι σημαντικός στον εντοπισμό των περιοχών που βιώνουν τοπική εξάπλωση σε αντίθεση με περιστατικά που συνδέονται αποκλειστικά με ιστορικά ταξιδίων. Οι αλληλουχίες μας βοηθούν να διακρίνουμε αυτά τα δύο σενάρια.
<br><br>
Εδώ, το δέντρο είναι χρωματισμένο με βάση το ιστορικό ταξιδιού ενός κρούσματος, όταν αυτό ήταν γνωστό. Βλέποντας την αλληλουχία από τον Καναδά (Canada/BC_78548/2020) στη μέση, παρατηρούμε ότι έχει ένα ιστορικό ταξιδιού στην Ευρώπη. Αυτό το περιστατικό ομαδοποιείται με άλλες ευρωπαϊκές αλληλουχίες, δείχνοτας έτσι ότι αυτή η περίπτωση σχετίζεται σχεδόν με σιγουριά με ένα γεγονός ταξιδίου. 


<!-- ############ SLIDE BREAK ############# -->
<!-- This is left-side text 7 -->
# [Οι πληροφορίες από τις αλληλουχίες μπορούν να διασταυρώσουν ιστορικά ταξιδίων](https://nextstrain.org/ncov/2020-03-20?c=division_exposure&d=tree&f_division_exposure=Iran&legend=open&p=full)

Με σμίκρυνση, βλέπουμε ότι αυτό δεν είναι πάντα συνεπές.
<br><br>
Εδώ μπορούμε να δούμε ότι σχεδόν όλα τα περιστατικά που έχουν πρόσφατα ιστορικά ταξιδίων στο Ιράν, ομαδοποιούνται στη μέση του δέντρου.
<br><br>
Προς την κορυφή του δέντρου, βλέπουμε επίσης ένα καναδικό περιστατικό με ιστορικό ταξιδίου στο Ιράν. Ωστόσο, αυτή η αλληλουχία δεν ομαδοποιείται με κανένα άλλο περιστατικό που έχει ιστορικό ταξιδίου στο Ιράν.
<br><br>
Είναι σχεδόν σίγουρο ότι αυτό το άτομο μολύνθηκε από μια δευτερογενή αλυσίδα μετάδοσης του ιού στο Ιράν, αλλά μέχρι να έχουμε περισσότερα δεδομένα δεν μπορούμε να βεβαιώσουμε ότι αυτή η μόλυνση έλαβε χώρα στο ταξίδι.
...
Αυτό σημαίνει ότι αυτού του είδους η αναπόφευκτη μετακίνηση των ανθρώπων έχει ήδη εισάγει τον ιό σε πολλά μέρη της υφηλίου.
<br><br>
Όντως [ο ΠΟΥ αναφέρει](https://www.who.int/docs/default-source/coronaviruse/situation-reports/20200319-sitrep-59-covid-19.pdf?sfvrsn=c3dcdef9_2) ότι υπάρχουν επιβεβαιωμένα κρούσματα σε 159 από τις 195 χώρες του κόσμου.
<br><br>
...
Ίσως να φαίνεται ότι ο COVID-19 ξέσπασε ξαφνικά.
Για πολλούς ανθρώπους, η πανδημία αυτή φαινομενικά ίσως μέσα σε μια βραδιά να έγινε από μια αφηρημένη ανησυχία που αγγίζει μακρινά μέρη στον κόσμο σε κάτι που έχει σοβαρές επιπτώσεις στην καθημερινή τους ζωή.
<br><br>
...
<br><br>
Περιοχές που δεν είναι ακόμα ενήμερες σχετικά με τοπικά ξεσπάσματα, θα πρέπει τώρα να ετοιμαστούν και να ξεκινήσουν τους ελέγχους επιτήρησης.

<!-- This is the right-side text -->

```auspiceMainDisplayMarkdown
# Πώς οι εισαγωγές καταλήγουν σε επιδημίες;

Μερικές φορές οι εισαγωγές δεν καταλήγουν σε δευτερογενή κρούσματα ή σε τοπικά ξεσπάσματα -- ειδικά εάν το αρχικό κρούσμα εντοπιστεί και απομονωθεί εγκαίρως.
...
Παρακάτω θα βρείτε ένα πείραμα σκέψης το οποίο δείχνει πώς το παραπάνω έπαιξε ρόλο στο Wuhan. Ο άξονας ψ αντιπροσωπεύει το χώρο, ο άξονας χ το χρόνο. H σκιασμένη περιοχή αντιπροσωπεύει τον αριθμό κρουσμάτων.

"Ο COVID-19 στο Wuhan εξελίχθηκε από ένα μοναδικό κρούσμα την περίοδο του Νοέμβρη 2019, σε πολλές χιλιάδες κρούσματα στα μέσα Γενάρη 2020, ξεκινώντας από ένα αρχικό περιστατικό και καταλήγοντας σε μια εκτεταμένη τοπική εξάπλωση σε ένα χρονικό διάστημα περίπου 10 εβδομάδων. Θεωρούμε ότι τα διεθνή γεγονότα διασποράς του ιού ξεκίνησαν γύρω στα μέσα του Γενάρη 2020. Επομένως έχουμε τις περίπου 10 κρίσιμες εβδομάδες από τότε έως και τα τέλη Μάρτη ώστε να περιορίσουμε τα γεγονότα αυτά της πανδημίας πριν να πάρουν μεγάλες διαστάσεις" [- Trevor Bedford](https://twitter.com/trvrb/status/1226241284207038464), Φεβρουάριος 2020.

Οι επιδημίες αυτές μπορεί με τη σειρά τους να εισάγουν τον ιό σε άλλες τοποθεσίες.
...
# [Πώς αναπτύσσονται οι επιδημίες: ένα παράδειγμα](https://nextstrain.org/ncov/2020-03-20?legend=closed&d=tree,map&f_division=Washington&label=clade:B1&p=grid&r=location)

Βλέπουμε ένα ξεκάθαρο παράδειγμα ανάπτυξης στα δεδομένα από την πολιτεία της Washington.
Η κύλιση του κέρσορα πάνω στη ρίζα του κεντρικού κλαδιού δείχνει ότι ο ιός πιθανών εισήχθη σε αυτήν την περιοχή μεταξύ του τέλους Γενάρη και μέσα Φεβρουαρίου 2020. ([methods](https://nextstrain.org/narratives/trees-background?n=6)).
<br><br>
Τώρα, στα μέσα Μάρτη, περίπου 6 εβδομάδες μετά, βλέπουμε ότι ένα τοπικό ξέσπασμα φαίνεται ξεκάθαρα στην περιοχή. Από τα δεδομένα των αλληλουχιών μόνο, υπολογίζουμε ένα ρυθμό διπλασιασμού κάθε 3-6 μέρες, υποθέτοντας ότι ο πληθυσμός αυξάνεται εκθετικά.
<br>
...
# [Πώς επεκτείνονται οι επιδημίες: ένα παράδειγμα](https://nextstrain.org/ncov/2020-03-20?legend=closed&d=tree,map&f_division=Washington,Utah&label=clade:B1&p=grid)

Μπορούμε επίσης να δούμε ένα παράδειγμα σχετικά με το πώς τα ξεσπάσματα που αρχικά εντοπίζονται τοπικά, σπείρουν τον ιό σε άλλες τοποθεσίες.
Τα δείγματα από τη Utah κοντά στην κορυφή του δέντρου (πορτοκαλί), φωλιάζουν μέσα στο κύριο κλαδί της επιδημίας στην Washington.
...
<br><br>
Δε γνωρίζουμε με βεβαιότητα εάν αυτή η εισαγωγή θα έχει ως αποτέλεσμα μια τοπική επιδημία στη Utah.
Όμως εάν ο ιός συνεχίσει να εξαπλώνεται μετά από αυτές τις εισαγωγές, αναμένουμε να δούμε την εξάπλωση να ξεδιπλώνεται μέσα στις επόμενες 4 εβδομάδες.
<br><br>
Αυτό είναι ένα παράδειγμα.
Ίσως υπάρχουν κι άλλες εισαγωγές στη Utah ή και σε άλλες περιοχές, τις οποίες δεν μπορούμε να δούμε στο δέντρο διότι δεν έχουν αλληλουχηθεί.
...
# [Τα μέτρα απομόνωσης παίρνουν χρόνο, όμως σώζουν ζωές](https://nextstrain.org/ncov/2020-03-20)

Ακολουθώντας αυτή τη λογική, ενδεχομένως να υπάρχουν πολλές αλυσίδες τοπικής εξάπλωσης τις οποίες δε γνωρίζουμε.
<br><br>
Αυτό σημαίνει ότι ακόμα και σε περιοχές που έχουν επιβληθεί μέτρα κοινωνικού περιορισμού, θα πρέπει να αναμένουμε ότι τα κρούσματα θα αυξηθούν τις επόμενες εβδομάδες.
Αυτές οι αυξήσεις ΔΕΝ αποτελούν απόδειξη ότι τα μέτρα απομόνωσης δε λειτουργούν. Χρειάζετει να περάσει χρόνος ώστε αυτοί που φέρουν τον ιό (και πιθανώς και τα μέλη των οικογενειών τους) να αναπτύξουν συμπτώματα, να νοσηλευθούν και να ανακάμψουν. Αναμένουμε επίσης να δούμε μια μεγάλη αύξηση στον αριθμό των επιβεβαιωμένων κρουσμάτων, όσο οι έλεγχοι πραγματοποιούνται σε μεγαλύτερο φάσμα και καθίστανται ευρέως διαθέσιμοι.
<br><br>
Είναι κρίσιμης σημασίας να διατηρούνται τα μέτρα απομόνωσης αυτήν την περίοδο. Όπως φαίνεται δεξιά, ο αριθμός των κρουσμάτων συνεχίζει να αυξάνεται και μετά την επιβολή των μέτρων. Όμως σε βάθος χρόνου, ο αριθμός των κρουσμάτων που συσσωρεύονται μειώνεται σημαντικά.

<!-- This is the right-side text -->

```auspiceMainDisplayMarkdown
## Τα μέτρα απομόνωσης δε σταματούν την εξάπλωση μέσα σε μια νύχτα, αλλά μειώνουν σημαντικά τα κρούσματα και τους θανάτους σε βάθος χρόνου.
Τα μέτρα κοινωνικής απομόνωσης -- αυτό σημαίνει μείωση των ανθρώπινων συναναστροφών μέσα στη μέρα -- μπορεί να είναι δύσκολα στην εφαρμογή τους, είναι ωστόσο κρίσιμης σημασίας για το κοινό καλό.

Εάν όλοι μειώσουν τις καθημερινές κοινωνικές τους επαφές κατά 25%, αναμένουμε μια μείωση της τάξης του 50% στο συνολικό αριθμό κρουσμάτων μέσα στον επόμενο μήνα ([Klein et al., 2020-03-13](https://institutefordiseasemodeling.github.io/COVID-public/reports/Working%20paper%20%E2%80%93%20model-based%20estimates%20of%20COVID-19%20burden%20in%20King%20and%20Snohomish%20counties%20through%20April%207.pdf)).
...
# [Συνοψίζοντας](https://nextstrain.org/ncov/2020-03-20?c=country&d=map&p=full)
- Ο ιός έχει εισαχθεί σε πολλά μέρη της υφηλίου πολλαπλές φορές.  
<br>
...
<br>
- Η συγκράτηση των τοπικών επιδημιών μέσω μέτρων απομόνωσης είναι κρίσιμη για να:
  - Ισοπεδωθεί η καμπύλη (#FlattenTheCurve) ώστε να αποφευχθεί η υπερφόρτωση των συστημάτων υγείας από συρρέοντα περιστατικά
...
* Υποστηρίξτε οικονομικά αυτούς που πλήγονται από τα μέτρα αποκλεισμού (π.χ. ωρομίσθιους, ανθρώπους που εργάζονται στον τομέα φροντίδας παιδιών και ηλικιωμένων, μικρές επιχειρήσεις, κλπ, κλπ)
...
# [Επιστημονικές ευχαριστίες](https://nextstrain.org/ncov/2020-03-20?d=map&c=author)
