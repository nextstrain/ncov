...
<br><br>地図を拡大すると、イタリアと他の地域との間に多くのリンクがあることがわかります。ただし、これらのリンクの方向性を確実に推測できるわけではないことに注意してください。他の仮説でもこれらのデータを説明できます(たとえば、遺伝子配列分析された症例はイタリアと他の場所の両方で、収集されていないある症例によって感染が生じ、二次的な症例である場合)
