...
We welcome translations of the situation reports (narratives) into languages other than English (in particular to languages of countries affected by the outbreak), and have been very impressed with the contributions provided so far.
Please get in touch if you can help.

We suggest creating a branch for each language after each release of the English version.
...
Due to data sharing agreements, we are not able to publicly provide these files (please see [this issue](https://github.com/nextstrain/ncov/issues/53) as we are trying to improve this).
