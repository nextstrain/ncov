...
if __name__ == '__main__':
    ...
    parser.add_argument("--Nweight", type = float, default=0.003, required=False, help="parametrizes de-prioritization of incomplete sequences")
    parser.add_argument("--crowding-penalty", type = float, default=0.01, required=False, help="parametrizes how priorities decrease when there is many very similar sequences")
